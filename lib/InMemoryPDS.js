...
function Storage(parentStorage){
    var internalValuesInPersistence = null ;
    if(!parentStorage instanceof  Storage){
        internalValuesInPersistence = parentStorage;
        parentStorage = null;
    }
...
function InMemoryPDS(internalValues, diskPersistence, shareHoldersCount){

    var mainStorage = new Storage(internalValues);
    ...
    this.persist(transactionLog, currentPulse){
        diskPersistence.persist(transactionLog, mainStorage.getInternalValues(), currentPulse);
    }
}


exports.newPDS = function(persistence){
    return new InMemoryPDS(undefined, persistence);
}